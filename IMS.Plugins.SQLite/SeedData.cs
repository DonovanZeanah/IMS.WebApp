...
namespace IMS.Plugins.SQLite
{
    public static class SeedData
    {
        ...
        public static void Initialize(IMSSQLiteDbContext db)
        {
            ...
            {
                new Inventory() { Id = 1, InventoryName = "Steering Wheel", Quantity = 10, Price = 30,  SourceId = 1 },
                new Inventory() { Id = 2, InventoryName = "Brake Pad", Quantity = 20, Price = 15,  SourceId = 1 },
                new Inventory() { Id = 3, InventoryName = "Air Filter", Quantity = 50, Price = 5,  SourceId = 2 },
                new Inventory() { Id = 4, InventoryName = "Spark Plug", Quantity = 100, Price = 2,  SourceId = 2 },
                new Inventory() { Id = 5, InventoryName = "Oil Filter", Quantity = 30, Price = 10,  SourceId = 1 },
                new Inventory() { Id = 6, InventoryName = "Tire", Quantity = 15, Price = 50,  SourceId = 1 },
                new Inventory() { Id = 7, InventoryName = "Battery", Quantity = 5, Price = 100,  SourceId = 2 },
                new Inventory() { Id = 8, InventoryName = "Wiper Blade", Quantity = 25, Price = 7,  SourceId = 1 },
                new Inventory() { Id = 9, InventoryName = "Alternator", Quantity = 2, Price = 150,  SourceId = 1 },
                new Inventory() { Id = 10, InventoryName = "Radiator", Quantity = 3, Price = 80,  SourceId = 2 },
                new Inventory() { Id = 11, InventoryName = "Shock Absorber", Quantity = 8, Price = 40,  SourceId = 1 },
                new Inventory() { Id = 12, InventoryName = "Fuel Filter", Quantity = 20, Price = 12,  SourceId = 1 },
                new Inventory() { Id = 13, InventoryName = "Serpentine Belt", Quantity = 12, Price = 18,  SourceId = 1 },
                new Inventory() { Id = 14, InventoryName = "Water Pump", Quantity = 5, Price = 75,  SourceId = 2 },
                new Inventory() { Id = 15, InventoryName = "Starter Motor", Quantity = 3, Price = 120,  SourceId = 1 },
                new Inventory() { Id = 16, InventoryName = "Brake Rotor", Quantity = 6, Price = 60,  SourceId = 1 },
                new Inventory() { Id = 17, InventoryName = "Timing Belt", Quantity = 8, Price = 25,  SourceId = 2 },
                new Inventory() { Id = 18, InventoryName = "Headlight Bulb", Quantity = 30, Price = 5,  SourceId = 1 },
                new Inventory() { Id = 19, InventoryName = "Exhaust Pipe", Quantity = 4, Price = 90,  SourceId = 1 },
                new Inventory() { Id = 20, InventoryName = "Oxygen Sensor", Quantity = 5, Price = 50,  SourceId = 2 },
                new Inventory() { Id = 21, InventoryName = "Steering Wheel", Quantity = 10, Price = 30,  SourceId = 1 },
                new Inventory() { Id = 22, InventoryName = "Driver Seat", Quantity = 100, Price = 20,  SourceId = 1 },
                new Inventory() { Id = 23, InventoryName = "Battery Bank", Quantity = 100, Price = 12,  SourceId = 2 },
                new Inventory() { Id = 24, InventoryName = "Drive Motor", Quantity = 100, Price = 1,  SourceId = 2 },
            };
            ...
            foreach (var inventory in inventories)
            {
                ...
                {
                    if (existingInventory.InventoryName != inventory.InventoryName || existingInventory.Quantity != inventory.Quantity || existingInventory.Price != inventory.Price || existingInventory.SourceId != inventory.SourceId)
                    {
